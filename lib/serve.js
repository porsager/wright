...
module.exports.start = function() {
  ...
  return new Promise((resolve, reject) => {
    ...
    module.exports.wss.on('connection', socket => socket.on('error', () => { /* noop */ }))
...
function handleJs(req, res) {
  ...
  if (js) {
    utils.promisify(js.compile).then(content =>
      content.map
        ? content.code + '//# sourceMappingURL=data:application/json;charset=utf-8;base64,' + new Buffer(JSON.stringify(content.map)).toString('base64')
