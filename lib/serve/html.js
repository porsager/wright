...
function hijack(res) {
  ...
  res.writeHead = function(status, headers) {
    headers && headers['content-length'] && (headers['content-length'] = parseInt(headers['content-length']) + extraByteLength)
    res.getHeader('content-length') && res.setHeader('content-length', parseInt(res.getHeader('content-length')) + extraByteLength)
